                ...
                <div className="row gap-sm-0">
                  <div className="col-md-4 col-6 mb-lg-0 mb-25">
                    ...
                    <ul className="list-unstyled">
                      <MenuList title="About Us" />
                      <MenuList title="Press Release" />
                      <MenuList title="Terms of Use" />
                  ...
                  <div className="col-md-4 col-6 mb-lg-0 mb-25">
                    ...
                    <ul className="list-unstyled">
                      <MenuList title="Refund Policy" />
                      <MenuList title="Unlock Rewards" />
                      <MenuList title="Live Chatting" />
                    </ul>
                  </div>
